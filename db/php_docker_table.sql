...
--
-- Host: db:3306
-- Generation Time: Apr 01, 2025 at 06:58 PM
...
CREATE TABLE `php_docker_table1` (
  `id` int NOT NULL,
  `title1` varchar(255) NOT NULL,
  `body1` text NOT NULL,
  `date_created1` date NOT NULL
...
(1, 'first post1', 'first message body1', '2025-02-01'),
(2, 'second post1', 'second post message1', '2025-03-21');
